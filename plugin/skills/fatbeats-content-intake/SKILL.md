...
# Fatbeats-content intake — the auto-manage loop
...
2. **Analyze.** Follow `fatbeats-content-analyze` (machine pass + your sequence pass).
3. **Edit.** Follow `fatbeats-content-edit` to produce and render 2-3 variants.
4. **Review.** Follow `fatbeats-content-review` on every variant; re-edit until each
   passes or is discarded.
5. **Caption.** Follow `fatbeats-content-caption` once at least one variant passes.
