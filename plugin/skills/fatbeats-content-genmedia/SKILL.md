---
name: fatbeats-content-genmedia
...
# Fatbeats-content genmedia (core mechanics)

The foundation under `fatbeats-content-gen-video` and `fatbeats-content-gen-composite`. Those
...
- Model drift on product artwork grows with distance from the seed —
  keep the product anchored to reference images (see fatbeats-content-gen-video).
