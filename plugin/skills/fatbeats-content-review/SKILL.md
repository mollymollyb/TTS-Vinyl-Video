---
name: fatbeats-content-review
description: Self-review a rendered edit before any human sees it — the system watching its own output. Use after fatbeats-content-edit renders a draft, or when the user says "review this cut", "check the edit", "did it cut mid-sequence". Catches mid-sequence cuts, dead space, and bad endings, then drives re-edits.
---

# Fatbeats-content review — the watch-itself loop
