---
name: fatbeats-content-gen-composite
description: Cut AI generations and real footage into finished platform-ready posts with ffmpeg - hook-then-real edits, supercuts, trims, caption passes, and two-parter stitches. Use when the user says "make the composite", "supercut", "trim and caption these", "cut this like a gen-z editor", or after fatbeats-content-gen-video produces raw generations.
---

# Fatbeats-content gen-composite

> Meme-format recipes (freeze-frame reaction, stutter repeat, chaos
> edit, ken-burns meme slideshow, rapid-fire text) live in
> `fatbeats-content-gen-meme` — same normalization contract as here.
...
- **Select cut**: a 15s generation keeps its best ~10-12s — trim the
  ...
  generated text.
- **Two-parter stitch**: part1 + continuation (fatbeats-content-gen-video
